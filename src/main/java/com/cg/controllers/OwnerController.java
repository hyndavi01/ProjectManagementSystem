...
public class OwnerController {
	...
	public ResponseEntity<Object> deleteOwner(@PathVariable("ownerId") Long ownerId) throws PersonNotFoundException
	{
		return ownerService.deleteOwner(ownerId);
	}
	
	@GetMapping("/getOwnerById/{ownerId}")
	public ResponseEntity<Object> getOwnerById(@PathVariable("ownerId") Long ownerId) throws PersonNotFoundException
	{
